...
export class PlayerService {
  ...
  private players = [
    ...
    new Player(5, 'Diego', 'Add a biography',  new Team(3, 'Valencia', 'app/img/Shields/ShieldValencia.png', 'app/img/Lineups/LineupValencia.jpg', "app/img/Equipments/EquipmentValencia.png", "app/img/Coaches/Ayestaran.jpg", "Pako Ayestaran", 'Add description', 'Add history',5), 'Alves', 'GoalKeeper', 'app/img/Flags/Brazil.png', "app/img/Players/DiegoAlves.jpg","app/img/PlayersIndex/DiegoAlves.jpg", 30, 4, 30, 1),
    new Player(6, 'Keylor', 'Add a biography', new Team(1, 'Real Madrid', 'app/img/Shields/ShieldRealMadrid.png', 'app/img/Lineups/LineupRealMadrid.jpg', "app/img/Equipments/EquipmentRealMadrid.png", "app/img/Coaches/Zidane.jpg" "Zinedine Zidane", 'Add description', 'Add history',2), 'Navas', 'GoalKeeper', 'app/img/Flags/CostaRica.png', "app/img/Players/Navas.jpg","app/img/PlayersIndex/Keylor.jpg", 29, 6,50,1),
    new Player(7, 'Claudio', 'Add a biography', new Team(2, 'Barcelona','app/img/Shields/ShieldBarcelona.png', 'app/img/Lineups/LineupBarcelona.jpg', "app/img/Equipments/EquipmentBarcelona.png", "app/img/Coaches/LuisEnrique.jpg", "Luis Enrique", 'Add description', "Add history",1), 'Bravo', 'GoalKeeper', 'app/img/Flags/Chile.png', "app/img/Players/Claudio.jpg","app/img/PlayersIndex/Bravo.jpg", 33, 5,82,13),
  ];
