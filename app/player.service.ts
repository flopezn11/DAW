...
export class PlayerService {
  ...
  private players = [
    ...
    new Player(7, 'Claudio', 'Add a biography', new Team(2, 'Barcelona'), 'Bravo', 'GoalKeeper', 'app/img/Flags/Argentina.png', "app/img/Players/LeoMessi.jpg","app/img/PlayersIndex/LeoMessi.jpg", 33,
  ];
